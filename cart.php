			...
			<div class="col-lg-10 offset-lg-1">
				<div class="cart_container">
					...
					<div class="cart_items">
						<ul class="cart_list">
							<?php foreach ($ct->getCartItems() as $id => $productData) : ?>
								<li class="cart_item clearfix">
									<div class="cart_item_image"><img src="<?= URL; ?>uploads/images/<?= $productData['img']; ?>" alt=""></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_action cart_info_col">
											...
											<div class="cart_item_text">
												<!-- اربط الزرار ده بصفحة مسح المنتج عن طريق الاى دى  -->
